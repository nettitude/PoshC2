...
sharphound --ZipFileName c:\\programdata\\backup.zip --JsonFolder c:\\programdata\\ --RandomFilenames --CollectionMethod Session,LocalGroup,LoggedOn,ObjectProps --NoSaveCache --SkipPing --ComputerFile c:\\programdata\\ctx.txt
