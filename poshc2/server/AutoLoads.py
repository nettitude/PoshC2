...
def run_autoloads(command, randomuri, user):
    ...
    elif command.startswith("invoke-inveigh"): check_module_loaded("Inveigh.ps1", randomuri, user)
...
def run_autoloads_sharp(command, randomuri, user):
    ...
    elif command.startswith("portscan"): check_module_loaded("PortScanner.dll", randomuri, user)
    elif command.startswith("run-exe sweetpotato.program "): check_module_loaded("SweetPotato.exe", randomuri, user)
    elif command.startswith("run-exe sharpdpapi.program "): check_module_loaded("SharpDPAPI.exe", randomuri, user)
    elif command.startswith("run-exe sharpchome.program "): check_module_loaded("SharpChrome.exe", randomuri, user)
